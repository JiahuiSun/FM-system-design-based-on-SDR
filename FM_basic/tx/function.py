...
def param_setting():
    ...
    Params['frame_time'] = 60e-3
    Params['sample_num'] = int(Params['sample_freq']*Params['frame_time'])
    Params['tx_os'] = 2

    Params['sym_num'] = 1800
    Params['sf_len'] = Params['sym_num']*Params['tx_os']
    
    Params['sym_rate'] = Params['sym_num']/Params['frame_time']    
    
    
    Params['os_N'] = Params['sample_num']/Params['sf_len']
    Params['filter_order'] = int(np.log2(Params['os_N']))

    print 'osr is ', Params['os_N']*2, Params['sym_rate']

    
    Params['filter_len'] = 25
    Params['b2'] = (c_double*Params['filter_len'])()
